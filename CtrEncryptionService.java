...
class CtrEncryptionService
{
 public SecretKeySpec myDesKey;
 public Base64 base64 = new Base64();
 
 public CtrEncryptionService() throws Exception
 {  
 ...
 {
	 	Cipher aesCipherForEncryption = Cipher.getInstance("AES/CTR/PKCS5PADDING"); 
		aesCipherForEncryption.init(Cipher.ENCRYPT_MODE, this.myDesKey,iv);
 ...
 {
		Cipher aesCipherForDecryption = Cipher.getInstance("AES/CTR/PKCS5PADDING"); 
		aesCipherForDecryption.init(Cipher.DECRYPT_MODE, this.myDesKey, iv);
